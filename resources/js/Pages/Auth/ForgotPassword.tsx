...
const ForgotPassword: React.FC = () => {
    ...
    const submit = async (e?: React.FormEvent | React.MouseEvent | React.KeyboardEvent) => {
        ...
        setTimeout(() => {
            ...
            setStatus('Password reset link sent! Check your email for further instructions.');
            setProcessing(false);
        }, 2000);
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 via-teal-50 to-lime-50 relative overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-40 left-8 md:bottom-32 md:left-1/4 opacity-30">
                    <LockIcon className="w-6 h-6 md:w-8 md:h-8 text-green-500 animate-bounce-gentle" />
                </div>
                ...
                <div className="absolute bottom-1/3 left-16 opacity-20">
                    <EnvelopeIcon className="w-10 h-10 text-teal-400 animate-float-slow delay-700" />
                </div>
            ...
            <div className={`relative z-10 w-full max-w-md transform transition-all duration-1000 ease-out ${
                ...
                <div className="backdrop-blur-lg bg-gradient-to-br from-white/90 to-white/70 border border-white/30 rounded-2xl md:rounded-3xl shadow-2xl shadow-emerald-200/30 p-6 md:p-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="text-center mb-8 animate-fade-in-up">
                            <div className="mx-auto w-16 h-16 bg-gradient-to-br from-emerald-500 via-green-500 to-teal-400 rounded-2xl flex items-center justify-center shadow-2xl shadow-emerald-200/50 mb-6 transform hover:scale-105 transition-transform duration-500 animate-float relative">
                            ...
                            <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 bg-clip-text text-transparent mb-2 animate-rainbow-text">
                                Forgot Your Password?
                            </h2>
                            <div className="w-12 md:w-16 h-1 bg-gradient-to-r from-emerald-500 via-green-500 to-teal-400 mx-auto rounded-full animate-gradient-shift mb-4"></div>
                        ...
                        {status && (
                            <div className="mb-6 p-4 bg-gradient-to-r from-emerald-50 via-green-50 to-teal-50 border-2 border-emerald-200/50 rounded-xl shadow-lg shadow-emerald-100/30 animate-slide-in-up">
                        ...
                        <div className="mt-8 flex items-center justify-between animate-slide-in-up delay-600">
                            <a
                                href="/login"
                                className="inline-flex items-center text-sm font-semibold text-emerald-600 hover:text-green-500 transition-all duration-300 hover:underline group"
                            >
                            ...
                            <a
                                href="/register"
                                className="text-sm font-semibold text-emerald-600 hover:text-green-500 transition-all duration-300 hover:underline"
                            >
                                Create Account
                            </a>
                        </div>
                        ...
                        <div className="mt-8 p-4 md:p-6 bg-gradient-to-r from-emerald-50 via-green-50 to-teal-50 rounded-xl border border-emerald-200/50 shadow-lg shadow-emerald-100/30 animate-slide-in-up delay-700">
                            ...
                            <div className="text-xs text-emerald-700 space-y-2">
                                <div className="flex items-center p-2 bg-gradient-to-r from-white/60 to-white/40 rounded-lg">
                                    <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3 animate-pulse delay-100"></div>
                                ...
                                <div className="flex items-center p-2 bg-gradient-to-r from-white/60 to-white/40 rounded-lg">
                                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3 animate-pulse delay-300"></div>
                                    <p>The reset link will expire in 60 minutes</p>
                                </div>
                                <div className="flex items-center p-2 bg-gradient-to-r from-white/60 to-white/40 rounded-lg">
                                    <div className="w-2 h-2 bg-lime-500 rounded-full mr-3 animate-pulse delay-400"></div>
                ...
                <div className="fixed inset-0 bg-slate-900/20 backdrop-blur-sm z-50 flex items-center justify-center">
                    <div className="bg-gradient-to-br from-white/95 to-white/85 rounded-3xl p-8 shadow-2xl border border-white/20 text-center max-w-sm mx-4 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-lg font-semibold bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 bg-clip-text text-transparent mb-2">Sending Reset Link</h3>
